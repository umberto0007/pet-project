...
const SignupSuccessMessage = ({active, setActive = () => {}}: FormsProps) => {
    ...
    return (
        <div
            className={`${active ? 'visible translate-x-0' : 'invisible translate-x-60'} fixed z-50 top-16 right-0 w-96 bg-white border-t-4 border-green-700 shadow-md rounded-b px-4 py-3 transition-transform duration-300`}
            role='alert'>
