                ...
                <section className='rounded-lg bg-gradient-to-r from-pink-500 mt-24'>
                    <Link to={`/groceries/${products && products[27].id}`} className='flex'>
                        <div className='flex flex-col p-10'>
                            <h2 className='text-4xl mt-10 text-white tracking-wide'>{products && products[27].title}</h2>
                            <h3 className='text-2xl mt-10 font-light text-white tracking-wide'>{products && products[27].description}</h3>
