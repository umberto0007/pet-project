...
import HeaderProfileNoAuth from '#components/Header/HeaderNavigate/HeaderProfile/HeaderProfileNoAuth';
import HeaderProfileWithAuth from '#components/Header/HeaderNavigate/HeaderProfile/HeaderProfileWithAuth';
